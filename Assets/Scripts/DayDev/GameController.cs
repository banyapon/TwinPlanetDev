...
public class GameController : MonoBehaviour
{
    ...
    public InputField input_email_login, input_pass_login;
    public InputField input_email, input_password, input_nickname, input_bio, input_fullname;
    public string jsonData;
    private string str_email, str_password, str_nickname, str_bio, str_fullname;
    ...
    public void RegisterUser()
    {
        ...
        if (str_email == "" || str_password == "" || str_nickname == "" || str_fullname == "")
        {
            ShowAlert();
        }
        else
        {
            ...
            param = "email=" + str_email + "&password=" + str_password + "&nickname=" + str_nickname + "&fullname=" + str_fullname + "&bio=" + str_bio + "&gender=" + gender_value;
    ...
    IEnumerator FetchResponseLogin(string URL)
    {
        ...
        else
        {
            ...
            if (status_code == "200")
            {
                ...
                PlayerPrefs.SetString("bio", jsonNode["bio"]);
                PlayerPrefs.Save();
                //Bypass
